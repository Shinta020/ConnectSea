...
@section('content')
    ...
    <div class="container header-left background-all">
        ...
        <div class="row-sm-12">
            <div id="kotak2">
                <p>Kakap merah mengandung vitamin D dan vitamin E. Kandungan vitamin D dapat membuat tulang kuat dan vitamin
                    E mendukung pertumbuhan sel darah merah yang sehat, membantu transportasi oksigen, dan menjadi
                    antioksidan alami bagi tubuh. Kakap merah mengandung magnesium dan selenium yang penting bagi tubuh.</p>
            </div>
        </div>
        <hr>
